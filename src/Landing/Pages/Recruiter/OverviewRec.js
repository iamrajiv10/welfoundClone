...
import HeaderReq from "../../Component/HeaderRec";
    ...
    <Layout title={"OverviewRec"}>
      <div>
        <div className="d-flex container my-4 gap-5">
          <div className="col " >
            <div className="w-75">
            <h1 className="text-warning my-2" style={{ fontSize: "60px" }}><b>You have vacancy.<br /> We have Candidates</b></h1>
